...
{
    const char* pszTimestamp = "Best coin";
    const CScript genesisOutputScript = CScript() << ParseHex("048E794284AD7E4D776919BDA05CDD38447D89B436BDAF5F65EBE9D7AD3A0B084908B88162BB60B1AA5ED6542063A30FC9584A335F656A54CD9F66D6C742B67F56") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("00000631a8ce78ed09786b78718226368670e90c20d524a4f4d546d1c940a72e");
        ...
        // Deployment of SegWit (BIP141, BIP143, and BIP68)
        ...
        pFile = fopen ("c:\Bitjet\log.log","w");
               ...
               CBlock bestGenesis;
                for (int i=0;i<5000000;i++) {
                   genesis = CreateGenesisBlock(1546165136, i, 0x1f0fffff, 1, 50 * COIN);
